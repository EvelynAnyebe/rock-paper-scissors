...
"""The following utilities are used to enhance the game"""
...
class RandomPlayer(Player):
    """This player picks moves at random"""
...
class HumanPlayer(Player):
    """This player represents the human"""
...
class ReflectivePlayer(Player):
    """This players remembers the last move the
    opponent last played and plays that this time"""
...
class CyclePlayer(Player):
    """This players remembers the last move it plays
     and cycles through the moves"""
